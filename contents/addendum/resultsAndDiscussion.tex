...
\begin{figure}
	...
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Ninf}
		\label{Fig5:S1Ninf}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.48\textwidth}
...
\begin{figure}
	...
	\begin{subfigure}[t]{0.4\textwidth}
		\centering
		\includegraphics[width=\textwidth]{S13D_IGA}
		\caption{IGA mesh}
	\end{subfigure}
	~    
	\begin{subfigure}[t]{0.4\textwidth}
		\centering
		\includegraphics[width=\textwidth]{S13D_SEM}
		\caption{SEM mesh}
	\end{subfigure}
...
\begin{figure}
	\centering
	\includegraphics[scale=1]{S1_cond}
...
\begin{figure}
	\centering
	\includegraphics[scale=1]{S1_timeBuildSystem}
...
\begin{figure}
	\centering
	\includegraphics[scale=1]{S1_timeSolveSystem}
...
\begin{figure}
	\centering
	\includegraphics[scale=1]{S1_tot_time}
