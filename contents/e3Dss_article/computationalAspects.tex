...
\begin{figure}
	...
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics{../../LaTeX/createFigures/TikzFigures/article_e3Dss_PhD/besselPlotLargeN_1}
%		\includegraphics[scale=1]{\graphicsFolder/Figure4a}
		\caption{Magnitude of Besselfunctions ploted for ${n\in[0,550]}$.}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.48\textwidth}
		\centering
		\includegraphics{../../LaTeX/createFigures/TikzFigures/article_e3Dss_PhD/besselPlotLargeN_2}
%		\includegraphics[scale=1]{\graphicsFolder/Figure4b}
...
\begin{figure}
	...
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[scale=1]{../../LaTeX/createFigures/TikzFigures/article_e3Dss_PhD/spy_K_1}
%		\includegraphics[scale=1]{\graphicsFolder/Figure5a}
	...
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics{../../LaTeX/createFigures/TikzFigures/article_e3Dss_PhD/spy_K_2}
%		\includegraphics[scale=1]{\graphicsFolder/Figure5b}
...
\begin{figure}
	...
	\begin{subfigure}[t]{0.49\textwidth}
		\includegraphics[width=\textwidth]{../../LaTeX/createFigures/TikzFigures/article_e3Dss_PhD/errors/errors_S135_SSBC_1}
%		\includegraphics[scale=0.95]{\graphicsFolder/Figure6a}
		\caption{Double precision, $\varepsilon \approx 10^{-16}$}
	\end{subfigure}%
	\hspace*{0.02\textwidth}%
	\begin{subfigure}[t]{0.49\textwidth}
		\includegraphics[width=\textwidth]{../../LaTeX/createFigures/TikzFigures/article_e3Dss_PhD/errors/errors_S135_SSBC_2}
%		\includegraphics[scale=0.95]{\graphicsFolder/Figure6b}
