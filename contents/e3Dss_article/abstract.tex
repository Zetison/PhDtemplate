%\textcolor{red}{
%\begin{itemize}
%	\item B{\o}r enheten inkludere en faktor sekund etter Fourier transformasjon (i.e. $\si{Pa} \cdot \si{s}$ for trykk)?
%	\item De sm{\aa} egenmodene til Fender benchmark m{\aa} kommenteres (de tilh{\o}rer ikke noen egenfrekvenser til skallet...).
%\end{itemize}
%}
