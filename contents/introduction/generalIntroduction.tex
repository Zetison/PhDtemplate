...
\begin{figure}
	\centering
	\includegraphics[scale=1]{physicalProblem}
...
\begin{figure}
	...
	\begin{subfigure}[t]{0.49\textwidth}
		\centering
		\includegraphics{elevationAspect}
	\end{subfigure}%
	\hspace*{0.02\textwidth}%
	\begin{subfigure}[t]{0.49\textwidth}
		\centering
		\includegraphics{elevationAspect_2}
	\end{subfigure}
...
\begin{figure}
	...
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[width=0.6\textwidth]{M1} % width = 0.6613/0.7
	...
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[width=0.6419\textwidth]{M2} % width = 0.6613/0.7
	...
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[width=0.76\textwidth]{M3} % width = 0.6613/0.7
	...
	\begin{subfigure}{0.33\textwidth}
		\centering
		\includegraphics[width=0.3\textwidth]{BeTSSi_M4} % width = 0.6613/0.7
		\caption{The BeTSSi model 4}
	\end{subfigure}%
	\hspace*{0.005\textwidth}%
	\begin{subfigure}{0.33\textwidth}
		\centering
		\includegraphics[width=0.45\textwidth]{BeTSSi_M5A}
		\caption{The BeTSSi model 5A}
	\end{subfigure}%
	\hspace*{0.005\textwidth}%
	\begin{subfigure}{0.33\textwidth}
		\centering
		\includegraphics[width=0.2\textwidth]{BeTSSi_M5B}
...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{betssi}
...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{BT_RBC_MS}
